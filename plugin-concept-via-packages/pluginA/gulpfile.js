...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      // Bundle's entry point
      // See https://github.com/rollup/rollup/wiki/JavaScript-API#entry
      entry: `${buildFolder}/sampleA.es5.js`,
