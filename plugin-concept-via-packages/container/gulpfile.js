...
gulp.task('rollup:es', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      entry: `${buildFolder}/rsw.template.uifornpm.js`,
    ...
    .pipe(rename('rsw.template.uifornpm.js'))
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      // Bundle's entry point
      // See https://github.com/rollup/rollup/wiki/JavaScript-API#entry
      entry: `${buildFolder}/rsw.template.uifornpm.es5.js`,
      ...
      moduleName: 'rsw.template.uifornpm',
    ...
    .pipe(rename('rsw.template.uifornpm.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
gulp.task('rollup:es5', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      // (required for bundles with exports)
      // See https://github.com/rollup/rollup/wiki/JavaScript-API#modulename
      moduleName: 'rsw.template.uifornpm-es5',
    ...
    .pipe(rename('rsw.template.uifornpm.es5.js'))
    .pipe(gulp.dest(distFolder));
});
